...
//+------------------------------------------------------------------+
//  ── ประวัติเวอร์ชัน ──────────────────────────────────────────────
//  3.1  เพิ่มเพดานล็อต InpMaxLot (เดิมไม่มีเลย เสี่ยง 5%/ไม้ จนชน 100 ล็อต)
//       แก้การไล่ SL ฝั่งซื้อ/ขายที่ไม่สมมาตรเพราะนับสเปรดซ้ำ
//       และเตือนค่าเสี่ยงสูงตอนเริ่มทำงาน
//  3.0  เวอร์ชันเดิมจากผู้เขียน
