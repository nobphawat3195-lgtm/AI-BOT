...
//|                                                                  |
//|  ── ประวัติเวอร์ชัน ──────────────────────────────────────────   |
//|  1.21  จูนระยะคร่อม 0.50->0.30 และจุดกันทุน 0.60->0.40           |
//|        (กวาด 81 ชุด 12 อันดับแรกใช้ 0.30 ทุกชุด) ทำให้บวกทุก     |
//|        สมมติฐานเส้นทางราคา 10/10 seeds เป็นครั้งแรก              |
//|  1.11  เปลี่ยนช่วงเวลาเป็น 08:00-09:00 + 20:00-21:00 เลือกจาก    |
//|        โครงสร้างตลาด (ช่วงวิ่ง/สเปรด) ตัด 02:00-03:30 ทิ้ง        |
//|  1.01  แก้บั๊ก: ห้ามเชื่อ TimeGMT() ใน Strategy Tester            |
